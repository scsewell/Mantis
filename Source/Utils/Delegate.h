...
namespace Mantis
{
    ...
    {
    public:
        Observer() : m_valid(eastl::make_shared<bool>(true)) {}

        virtual ~Observer() = default;

        eastl::shared_ptr<bool> m_valid;
    };
    ...
    {
    public:
        using ReturnType = eastl::vector<TReturnType>;
    ...
    public:
        ...
        using FunctionType = eastl::function<TReturnType(TArgs ...)>;
        using ObserversType = eastl::vector<eastl::weak_ptr<bool>>;
        ...
        void Add(FunctionType&& function, KArgs ...args)
        {
            ...
            m_functions.emplace_back(FunctionPair{ eastl::move(function), observers });
        }

        void Remove(const FunctionType& function)
        {
            std::lock_guard<std::mutex> lock(m_mutex);
            m_functions.erase(eastl::remove_if(m_functions.begin(), m_functions.end(), [function](FunctionPair & f)
                {
        ...
        {
            return Add(eastl::move(function));
        }
    ...
    private:
        ...
        std::mutex m_mutex;
        eastl::vector<FunctionPair> m_functions;
    };
    ...
    public:
        ...
        DelegateValue(Args ...args) : m_value(eastl::forward<Args>(args)...) {}
